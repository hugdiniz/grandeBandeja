...
public class DepartamentoTest {
	...
	public void testAtualizarDepartamento() throws SQLException
	{
		...
		String nome = null;
		DepartamentoVO deptVo = new DepartamentoVO("Departamento Libra","DL");
		
		try 
		{
			Departamento.getInstance().atualizarDepartamento(deptVo); 
			PreparedStatement prep = ConnectionFactory.getConnection().prepareStatement("select * from departamento where sigla like 'DL'");
